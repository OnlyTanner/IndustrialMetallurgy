...
public class BlockBellow extends BlockHorizontal {
    ...
    public BlockBellow() {
        super(Material.WOOD);
        setUnlocalizedName(Reference.IndustrialMetallurgyBlocks.BELLOW.getUnlocalizedName());
        setRegistryName(Reference.IndustrialMetallurgyBlocks.BELLOW.getRegistryName());
        setHardness(3.0F);

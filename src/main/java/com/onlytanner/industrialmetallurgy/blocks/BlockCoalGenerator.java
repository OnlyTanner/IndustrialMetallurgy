...
public class BlockCoalGenerator extends BlockContainer {
    ...
    public BlockCoalGenerator(boolean isBurning, String unlocalizedName, String registryName) {
        super(Material.IRON);
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, ItemStack heldItem, EnumFacing side, float hitX, float hitY, float hitZ) {
        if (!worldIn.isRemote) {
            playerIn.openGui(IndustrialMetallurgy.instance, GuiHandlerCoalGenerator.getGuiID(), worldIn, pos.getX(), pos.getY(), pos.getZ());
        }
        return true;
    }
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
        if (!keepInventory) {
            ...
            if (tileentity instanceof TileEntityCoalGenerator) {
                InventoryHelper.dropInventoryItems(worldIn, pos, (TileEntityCoalGenerator) tileentity);

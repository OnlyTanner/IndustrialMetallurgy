...
public class BlockCrusher extends BlockContainer {
    ...
    public BlockCrusher(boolean isBurning, String unlocalizedName, String registryName) {
        super(Material.IRON);
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, ItemStack heldItem, EnumFacing side, float hitX, float hitY, float hitZ) {
        if (!worldIn.isRemote) {
            playerIn.openGui(IndustrialMetallurgy.instance, GuiHandlerCrusher.getGuiID(), worldIn, pos.getX(), pos.getY(), pos.getZ());
        }
        return true;
    }
...
//        else
//        {
        worldIn.setBlockState(pos, ModBlocks.crusher.getDefaultState().withProperty(FACING, blockState.getValue(FACING)), 3);
        worldIn.setBlockState(pos, ModBlocks.crusher.getDefaultState().withProperty(FACING, blockState.getValue(FACING)), 3);
//        }

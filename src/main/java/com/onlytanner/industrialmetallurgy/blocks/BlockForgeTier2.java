...
public class BlockForgeTier2 extends BlockContainer {

    public static final PropertyDirection FACING = BlockHorizontal.FACING;
    private final boolean IS_BURNING;
    private static boolean keepInventory;

    public BlockForgeTier2(boolean isBurning, String unlocalizedName, String registryName) {
        super(Material.IRON);
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) {
        return Item.getItemFromBlock(ModBlocks.forge_tier2);
    }
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, ItemStack heldItem, EnumFacing side, float hitX, float hitY, float hitZ) {
        if (!worldIn.isRemote) {
            playerIn.openGui(IndustrialMetallurgy.instance, GuiHandlerForgeTier2.getGuiID(), worldIn, pos.getX(), pos.getY(), pos.getZ());
        }
        return true;
    }
    ...
    public static void setState(boolean active, World worldIn, BlockPos pos) {
        ...
        if (active) {
            ...
            worldIn.setBlockState(pos, ModBlocks.forge_tier2.getDefaultState().withProperty(FACING, blockState.getValue(FACING)), 3);
            worldIn.setBlockState(pos, ModBlocks.forge_tier2.getDefaultState().withProperty(FACING, blockState.getValue(FACING)), 3);
        }
    ...
    public TileEntity createNewTileEntity(World worldIn, int meta) {
        return new TileEntityForgeTier2();
    }
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
        if (!keepInventory) {
            ...
            if (tileentity instanceof TileEntityForgeTier2) {
                InventoryHelper.dropInventoryItems(worldIn, pos, (TileEntityForgeTier2) tileentity);
    ...
    public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state) {
        return new ItemStack(ModBlocks.forge_tier2);
    }

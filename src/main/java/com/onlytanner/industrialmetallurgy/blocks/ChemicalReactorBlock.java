...
public class ChemicalReactorBlock extends Block {
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return ModTileEntityTypes.CHEMICAL_REACTOR.get().create();
    }
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, BlockState state, LivingEntity placer, ItemStack stack) {
        ...
        if (stack.hasDisplayName()) {
            ...
            if (tile instanceof ChemicalReactorTileEntity) {
                ((ChemicalReactorTileEntity) tile).setCustomName(stack.getDisplayName());
            }
        }
    }
    ...
    public void onReplaced(BlockState state, World worldIn, BlockPos pos, BlockState newState, boolean isMoving) {
        TileEntity tile = worldIn.getTileEntity(pos);
        if (tile instanceof ChemicalReactorTileEntity && state.getBlock() != newState.getBlock()) {
            ChemicalReactorTileEntity furnace = (ChemicalReactorTileEntity) tile;

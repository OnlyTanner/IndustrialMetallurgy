...
public class ForgeTier3Block extends Block {

    public static final DirectionProperty FACING = BlockStateProperties.HORIZONTAL_FACING;
    public static final BooleanProperty LIT = BooleanProperty.create("lit");

    public ForgeTier3Block(Properties properties) {
        super(properties);
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return ModTileEntityTypes.FORGE_TIER3.get().create();
    }
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, BlockState state, LivingEntity placer, ItemStack stack) {
        ...
        if (stack.hasDisplayName()) {
            ...
            if (tile instanceof ForgeTier3TileEntity) {
                ((ForgeTier3TileEntity) tile).setCustomName(stack.getDisplayName());
            }
        }
    }
    ...
    public void onReplaced(BlockState state, World worldIn, BlockPos pos, BlockState newState, boolean isMoving) {
        TileEntity tile = worldIn.getTileEntity(pos);
        if (tile instanceof ForgeTier3TileEntity && state.getBlock() != newState.getBlock()) {
            ForgeTier3TileEntity furnace = (ForgeTier3TileEntity) tile;

...
public class SolderingStationBlock extends Block {
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return ModTileEntityTypes.SOLDERING_STATION.get().create();
    }
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, BlockState state, LivingEntity placer, ItemStack stack) {
        ...
        if (stack.hasDisplayName()) {
            ...
            if (tile instanceof SolderingStationTileEntity) {
                ((SolderingStationTileEntity) tile).setCustomName(stack.getDisplayName());
            }
        }
    }
    ...
    public void onReplaced(BlockState state, World worldIn, BlockPos pos, BlockState newState, boolean isMoving) {
        TileEntity tile = worldIn.getTileEntity(pos);
        if (tile instanceof SolderingStationTileEntity && state.getBlock() != newState.getBlock()) {
            SolderingStationTileEntity furnace = (SolderingStationTileEntity) tile;

...
@OnlyIn(Dist.CLIENT)
public class ChemicalCentrifugeScreen extends ContainerScreen<ChemicalCentrifugeContainer> {

    private static final ResourceLocation TEXTURE = new ResourceLocation(IndustrialMetallurgy.MOD_ID, "textures/gui/container/chemical_centrifuge.png");

    private final int PROGRESS_X = 98, PROGRESS_Y = 16, PROGRESS_WIDTH = 9, PROGRESS_HEIGHT = 28;
    private final int ENERGY_X = 8, ENERGY_Y = 8, ENERGY_WIDTH = 16, ENERGY_HEIGHT = 70;

    public ChemicalCentrifugeScreen(ChemicalCentrifugeContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {

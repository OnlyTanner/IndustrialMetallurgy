...
public class ExtruderScreen extends ContainerScreen<ExtruderContainer> {
    ...
    public ExtruderScreen(ExtruderContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
    ...
    protected void drawGuiContainerBackgroundLayer(MatrixStack matrixStack, float partialTicks, int x, int y) {
        ...
        this.blit(matrixStack, this.guiLeft + PROGRESS_X, this.guiTop + PROGRESS_Y, 176, 0, this.container.getSmeltProgressionScaled(), 18);
        int yOffset = 70 - this.container.getCurrentEnergyScaled();
        this.blit(matrixStack, this.guiLeft + 8, this.guiTop + 8 + yOffset, 176, yOffset + 18, 16, this.container.getCurrentEnergyScaled());
    }

...
public class SolderingStationScreen extends ContainerScreen<SolderingStationContainer> {
    ...
    public SolderingStationScreen(SolderingStationContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
    ...
    protected void drawGuiContainerBackgroundLayer(MatrixStack matrixStack, float partialTicks, int x, int y) {
        ...
        this.blit(matrixStack, this.guiLeft + PROGRESS_X, this.guiTop + PROGRESS_Y, 176, 0, this.container.getSmeltProgressionScaled(), 17);

...
public class ContainerCoalGenerator extends Container {
    ...
    public final int FURNACE_SLOTS_COUNT = FUEL_SLOTS_COUNT;
    ...
    public ContainerCoalGenerator(InventoryPlayer invPlayer, IInventory inventory) {
        ...
        this.addSlotToContainer(new SlotFuel(inventory, FIRST_FUEL_SLOT_NUMBER, 80, 35)); //fuel slot
    }
    ...
    public ItemStack transferStackInSlot(EntityPlayer player, int sourceSlotIndex) {
        ...
        if (sourceSlotIndex >= VANILLA_FIRST_SLOT_INDEX && sourceSlotIndex < VANILLA_FIRST_SLOT_INDEX + VANILLA_SLOT_COUNT) {
            ...
            if (TileEntityCoalGenerator.getItemBurnTime(sourceStack) > 0) {
    ...
    public class SlotFuel extends Slot {
        ...
        public boolean isItemValid(ItemStack stack) {
            return TileEntityCoalGenerator.isItemValidForFuelSlot(stack);
        }
    }
}

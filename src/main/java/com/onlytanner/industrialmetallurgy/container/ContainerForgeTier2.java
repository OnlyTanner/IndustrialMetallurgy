...
public class ContainerForgeTier2 extends Container {
    ...
    public ContainerForgeTier2(InventoryPlayer invPlayer, IInventory inventory) {
        ...
        this.addSlotToContainer(new Slot(inventory, FIRST_INPUT_SLOT_NUMBER, 60, 16)); //top input slot
        this.addSlotToContainer(new Slot(inventory, FIRST_INPUT_SLOT_NUMBER + 1, 41, 35)); //middle input slot
        this.addSlotToContainer(new Slot(inventory, FIRST_INPUT_SLOT_NUMBER + 2, 60, 54)); //bottom input slot
    ...
    public ItemStack transferStackInSlot(EntityPlayer player, int sourceSlotIndex) {
        ...
        if (sourceSlotIndex >= VANILLA_FIRST_SLOT_INDEX && sourceSlotIndex < VANILLA_FIRST_SLOT_INDEX + VANILLA_SLOT_COUNT) {
            ...
            if (TileEntityForgeTier2.getSmeltingResultForItem(sourceStack, sourceStack.stackSize) != null || ForgeRecipes.isPotentialInput(sourceStack.getItem())) {
                if (!mergeItemStack(sourceStack, FIRST_INPUT_SLOT_INDEX, FIRST_INPUT_SLOT_INDEX + INPUT_SLOTS_COUNT, false)) {
                    return null;
                }
            } else if (TileEntityForgeTier2.getItemBurnTime(sourceStack) > 0) {
    ...
    public class SlotFuel extends Slot {
        ...
        public boolean isItemValid(ItemStack stack) {
            return TileEntityForgeTier2.isItemValidForFuelSlot(stack);
        }
    }

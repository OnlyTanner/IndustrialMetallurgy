...
public class ContainerForgeTier3 extends Container {
    ...
    public ContainerForgeTier3(InventoryPlayer invPlayer, IInventory inventory) {
        ...
        this.addSlotToContainer(new Slot(inventory, FIRST_INPUT_SLOT_NUMBER, 60, 16)); //top input slot 2
        this.addSlotToContainer(new Slot(inventory, FIRST_INPUT_SLOT_NUMBER + 1, 38, 54)); //bottom input slot 1
        this.addSlotToContainer(new Slot(inventory, FIRST_INPUT_SLOT_NUMBER + 1, 60, 54)); //bottom input slot 2
    ...
    public class SlotFuel extends Slot {
        ...
        public boolean isItemValid(ItemStack stack) {
            return TileEntityForgeTier3.isItemValidForFuelSlot(stack);
        }
    }

...
import com.onlytanner.industrialmetallurgy.tileentity.ExtruderTileEntity;
...
public class ExtruderContainer extends Container {
    ...
    public final ExtruderTileEntity te;
    ...
    private static ExtruderTileEntity getTileEntity(final PlayerInventory playerInv, final PacketBuffer data) {
        Objects.requireNonNull(playerInv, "playerInv cannot be null");
        Objects.requireNonNull(data, "data cannot be null");
        final TileEntity tileAtPos = playerInv.player.world.getTileEntity(data.readBlockPos());
        if (tileAtPos instanceof ExtruderTileEntity) {
            return (ExtruderTileEntity) tileAtPos;
        }
    ...
    public boolean canInteractWith(PlayerEntity playerIn) {
        return isWithinUsableDistance(canInteractWithCallable, playerIn, RegistryHandler.EXTRUDER.get());
    }

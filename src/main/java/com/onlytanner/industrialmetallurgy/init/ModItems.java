...
public class ModItems 
{
    ...
    public static Item sulfuric_acid_bottle;
    public static Item methane_bottle;
    public static Item petroleum_bottle;
    public static Item ethylene_bottle;
    ...
    public static Item battery_cell;
    public static Item battery_bank;
    ...
    public static void init() {
        ...
        refractory_composite = new ItemBase(IndustrialMetallurgyItems.REFRACTORY_COMPOSITE.getUnlocalizedName(), IndustrialMetallurgyItems.REFRACTORY_COMPOSITE.getRegistryName(), IndustrialMetallurgy.RESOURCES_TAB);
        refractory_brick = new ItemBase(IndustrialMetallurgyItems.REFRACTORY_BRICK.getUnlocalizedName(), IndustrialMetallurgyItems.REFRACTORY_BRICK.getRegistryName(), IndustrialMetallurgy.RESOURCES_TAB);
        coal_coke = new ItemCoalCokeFuel();
        fertilizer = new ItemBase(IndustrialMetallurgyItems.FERTILIZER.getUnlocalizedName(), IndustrialMetallurgyItems.FERTILIZER.getRegistryName(), IndustrialMetallurgy.RESOURCES_TAB);
        bitumen = new ItemBase(IndustrialMetallurgyItems.BITUMEN.getUnlocalizedName(), IndustrialMetallurgyItems.BITUMEN.getRegistryName(), IndustrialMetallurgy.RESOURCES_TAB);
        ...
        sulfuric_acid_bottle = new ItemBase(IndustrialMetallurgyItems.SULFURIC_ACID_BOTTLE.getUnlocalizedName(), IndustrialMetallurgyItems.SULFURIC_ACID_BOTTLE.getRegistryName(), IndustrialMetallurgy.RESOURCES_TAB);
        methane_bottle = new ItemBase(IndustrialMetallurgyItems.METHANE_BOTTLE.getUnlocalizedName(), IndustrialMetallurgyItems.METHANE_BOTTLE.getRegistryName(), IndustrialMetallurgy.RESOURCES_TAB);
        petroleum_bottle = new ItemBase(IndustrialMetallurgyItems.PETROLEUM_BOTTLE.getUnlocalizedName(), IndustrialMetallurgyItems.PETROLEUM_BOTTLE.getRegistryName(), IndustrialMetallurgy.RESOURCES_TAB);
        ethylene_bottle = new ItemBase(IndustrialMetallurgyItems.ETHYLENE_BOTTLE.getUnlocalizedName(), IndustrialMetallurgyItems.ETHYLENE_BOTTLE.getRegistryName(), IndustrialMetallurgy.RESOURCES_TAB);
        ...
        battery_cell = new ItemBase(IndustrialMetallurgyItems.BATTERY_CELL.getUnlocalizedName(), IndustrialMetallurgyItems.BATTERY_CELL.getRegistryName(), IndustrialMetallurgy.MACHINES_TAB);
        battery_bank = new ItemBase(IndustrialMetallurgyItems.BATTERY_BANK.getUnlocalizedName(), IndustrialMetallurgyItems.BATTERY_BANK.getRegistryName(), IndustrialMetallurgy.MACHINES_TAB);
    ...
    public static void register() {
        ...
        GameRegistry.register(sulfuric_acid_bottle);
        GameRegistry.register(methane_bottle);
        GameRegistry.register(petroleum_bottle);
        GameRegistry.register(ethylene_bottle);
        ...
        GameRegistry.register(battery_bank);
    ...
    public static void registerRenders() {
        ...
        registerRender(sulfuric_acid_bottle);
        registerRender(methane_bottle);
        registerRender(petroleum_bottle);
        registerRender(ethylene_bottle);
        ...
        registerRender(battery_cell);
        registerRender(battery_bank);

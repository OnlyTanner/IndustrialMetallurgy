...
public class ChemicalReactorRecipe implements ChemicalReactorRecipeBase {

    private final ResourceLocation id;
    private Ingredient input;
    private List<ItemStack> output;

    public ChemicalReactorRecipe(ResourceLocation id, Ingredient input, List<ItemStack> output) {
        this.id = id;
        this.input = input;
        this.output = output;
    }
    ...
    public IRecipeSerializer<?> getSerializer() {
        return RecipeSerializerInit.CHEMICAL_REACTOR_SERIALIZER.get();
    }

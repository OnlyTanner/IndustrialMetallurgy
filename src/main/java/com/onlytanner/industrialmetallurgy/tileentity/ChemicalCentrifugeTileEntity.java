...
public class ChemicalCentrifugeTileEntity extends TileEntity implements ITickableTileEntity, INamedContainerProvider, IEnergyStorage {
    ...
    public Container createMenu(final int windowID, final PlayerInventory playerInv, final PlayerEntity playerIn) {
        return new ChemicalCentrifugeContainer(windowID, playerInv, this);
    }
    ...
    public ITextComponent getDefaultName() {
        return new TranslationTextComponent("container." + IndustrialMetallurgy.MOD_ID + ".chemical_centrifuge");
    }
    ...
    @Nullable
    private ChemicalCentrifugeRecipe getRecipe() {
        if (this.inventory == null)
            return null;
        Set<IRecipe<?>> recipes = findRecipesByType(RecipeSerializerInit.CHEMICAL_CENTRIFUGE_RECIPE_TYPE, this.world);
        for (IRecipe<?> iRecipe : recipes) {
            ChemicalCentrifugeRecipe recipe = (ChemicalCentrifugeRecipe) iRecipe;

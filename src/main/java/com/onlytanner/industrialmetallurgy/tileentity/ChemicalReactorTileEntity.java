    ...
    public void tick() {
        ...
        if (this.world != null && !this.world.isRemote) {
            ...
            if (this.getRecipe() != null && canProcess() && this.inventory.getStackInSlot(BURR_SET_ID).getCount() > 0 && energy >= ENERGY_USAGE_PER_TICK) {
                this.world.setBlockState(this.getPos(), this.getBlockState().with(ChemicalReactorBlock.LIT, true));
                ...
                this.world.setBlockState(this.getPos(), this.getBlockState().with(ChemicalReactorBlock.LIT, false));
                currentSmeltTime = 0;
            }
        }
        if (dirty) {

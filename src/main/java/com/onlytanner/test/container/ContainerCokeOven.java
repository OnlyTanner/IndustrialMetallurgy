package com.onlytanner.test.container;
...
public class ContainerCokeOven extends Container {
    ...
    public final int FURNACE_SLOTS_COUNT = FUEL_SLOTS_COUNT + OUTPUT_SLOTS_COUNT;
    ...
    private final int FIRST_OUTPUT_SLOT_INDEX = FIRST_FUEL_SLOT_INDEX + FUEL_SLOTS_COUNT;
    ...
    private final int FIRST_OUTPUT_SLOT_NUMBER = 1;

    public ContainerCokeOven(InventoryPlayer invPlayer, IInventory inventory) {
        ...
        this.addSlotToContainer(new SlotFuel(inventory, FIRST_FUEL_SLOT_NUMBER, 56, 35)); //fuel slot
        this.addSlotToContainer(new SlotOutput(inventory, FIRST_OUTPUT_SLOT_NUMBER, 116, 35)); //output slot 1
    }
    ...
    public ItemStack transferStackInSlot(EntityPlayer player, int sourceSlotIndex) {
        ...
        if (sourceSlotIndex >= VANILLA_FIRST_SLOT_INDEX && sourceSlotIndex < VANILLA_FIRST_SLOT_INDEX + VANILLA_SLOT_COUNT) {
            ...
            } else if (TileEntityCokeOven.getItemBurnTime(sourceStack) > 0) {
    ...
    public class SlotFuel extends Slot {
        ...
        public boolean isItemValid(ItemStack stack) {
            return TileEntityCokeOven.isItemValidForFuelSlot(stack);
        }
    }

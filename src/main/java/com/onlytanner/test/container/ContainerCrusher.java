...
public class ContainerCrusher extends Container
{
	...
	public ContainerCrusher(InventoryPlayer invPlayer, IInventory inventory) {
		...
		this.addSlotToContainer(new SlotFuel(inventory, FIRST_FUEL_SLOT_NUMBER, 56, 53)); //fuel slot
	...
	public ItemStack transferStackInSlot(EntityPlayer player, int sourceSlotIndex)
	{
		...
		if (sourceSlotIndex >= VANILLA_FIRST_SLOT_INDEX && sourceSlotIndex < VANILLA_FIRST_SLOT_INDEX + VANILLA_SLOT_COUNT) {
			...
			if (TileEntityCrusher.getCrushingResultForItem(sourceStack) != null){

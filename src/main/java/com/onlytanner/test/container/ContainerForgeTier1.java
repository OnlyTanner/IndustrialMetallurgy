...
public class ContainerForgeTier1 extends Container {
    ...
    public ContainerForgeTier1(InventoryPlayer invPlayer, IInventory inventory) {
    ...
    public ItemStack transferStackInSlot(EntityPlayer player, int sourceSlotIndex) {
        ...
        if (sourceSlotIndex >= VANILLA_FIRST_SLOT_INDEX && sourceSlotIndex < VANILLA_FIRST_SLOT_INDEX + VANILLA_SLOT_COUNT) {
            ...
            if (TileEntityForgeTier1.getSmeltingResultForItem(sourceStack, sourceStack.stackSize) != null || ForgeRecipes.isPotentialInput(sourceStack.getItem())) {
                if (!mergeItemStack(sourceStack, FIRST_INPUT_SLOT_INDEX, FIRST_INPUT_SLOT_INDEX + INPUT_SLOTS_COUNT, false)) {
                    return null;
                }
            } else if (TileEntityForgeTier1.getItemBurnTime(sourceStack) > 0) {
    ...
    public class SlotFuel extends Slot {
        ...
        public boolean isItemValid(ItemStack stack) {
            return TileEntityForgeTier1.isItemValidForFuelSlot(stack);
        }
    }

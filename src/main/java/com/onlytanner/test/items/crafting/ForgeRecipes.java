...
public class ForgeRecipes
{
    ...
    private ForgeRecipes()
    {
    	...
    	this.addAlloyRecipe(new ItemStack(Items.IRON_INGOT), new ItemStack(Items.COAL, 4), new ItemStack(ModItems.steel_ingot), 0.35F, 2700);
    }
    ...
    /**
     * Returns the AlloyRecipe array representation of all the currently stored alloy recipes
    ...
    /**
     * Representation of an alloy recipe which contains two input items and an output.
     * It also specifies the amount of experienced gained from any specific recipe.
     * 
    ...
    public class AlloyRecipe
    {
    	...
    	protected ItemStack getInput1() {return input1;}
    	protected ItemStack getInput2() {return input2;}
    	protected ItemStack getOutput() {return output;}
    	protected Float getExperience() {return experience;}

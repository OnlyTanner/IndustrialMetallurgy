...
public class TileEntityCokeOven extends TileEntityLockable implements IInventory, ITickable {
    ...
    public static ItemStack getSmeltingResultForItem(ItemStack stack) {
        return CokeOvenRecipes.instance().getSmeltingResult(stack);
    }

...
public class TileEntityCrusher extends TileEntityLockable implements IInventory, ITickable
{
    ...
    private boolean canCrush()
    {
        ...
        else
        {
            ...
            if (this.itemStacks[FIRST_OUTPUT_SLOT] == null || this.itemStacks[FIRST_OUTPUT_SLOT + 1] == null) return true;
            if (!this.itemStacks[FIRST_OUTPUT_SLOT].isItemEqual(itemstack) && !this.itemStacks[FIRST_OUTPUT_SLOT + 1].isItemEqual(itemstack)) return false;
            int result;
